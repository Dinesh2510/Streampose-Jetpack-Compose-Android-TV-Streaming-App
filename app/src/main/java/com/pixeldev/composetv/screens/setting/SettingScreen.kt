...
fun SettingScreen(
    ...
    Row(
        ...
        Column(
            ...
            SettingPage.entries.forEachIndexed { index, profileScreen ->
        ...
        NavHost(
            ...
            startDestination = SettingPage.Accounts(),
            builder = {
                composable(SettingPage.Accounts()) {
                    AccountsSection()
                }
                composable(SettingPage.About()) {
                    AboutSection()
                }
                composable(SettingPage.Subtitles()) {
                    SubtitlesSection(
                        isSubtitlesChecked = isSubtitlesChecked,
                        onSubtitleCheckChange = { isSubtitlesChecked = it }
                    )
                }
                composable(SettingPage.Language()) {
                    LanguageSection(
                        selectedIndex = selectedLanguageIndex,
                        onSelectedIndexChange = { selectedLanguageIndex = it }
                    )
                }
                composable(SettingPage.SearchHistory()) {
                    SearchHistorySection()
                }
                composable(SettingPage.HelpAndSupport()) {
